...
public class ExerciseAdapter extends RecyclerView.Adapter<ExerciseAdapter.ViewHolder> {
    ...
    private List<NewsCo> items;

    public ExerciseAdapter(Context context, List<NewsCo> items) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        NewsCo item = items.get(position);
        Picasso.get().load(item.getImg()).into(holder.logoImage);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView){
            ...
            namaText = itemView.findViewById(R.id.text_header);
        }
    }
}
